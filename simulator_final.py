...
class CryptoExecutor:
 ...
 #       # Stack
    ...
    def RunAsm(self, PC=None):
        ...
        while self._RF["PC"] != None and (PC != 781):
            self._RF["PC"] = PC   # Set current PC
    ...
    def _Execqand64    (self, Asm="", PC=None):
        ...
        if self._RF.IsLocked(ret1) or self._RF.IsLocked(r1) or self._RF.IsLocked(r2):
            ...
            s1 = (self._RF[r1 + '_e1']<<32) + self._RF[r1 + '_e0']
            s2 = (self._RF[r2 + '_e1']<<32) + self._RF[r1 + '_e0']
            self._Log.write("Source Reg 1 : %s = %x  \nSource Reg 2 : %s = %x  \n"%(r1, s1, r2, s2))
            result = s1 & s2
            self._RF[ret1 + '_e1'], self._RF[ret1 + '_e0'] = bit64_to_32(s1 & s2)
            # Information to be reported
            Matched, Instr = self._InstrSet.MatchedOnce(Asm)
            self.IncreaseIC(Instr)
            self.IncreaseCycles(Instr, "Serial", self._InstrSet.GetCycles(Instr))
    ...
    def _Execqand128    (self, Asm="", PC=None):
        ...
        if self._RF.IsLocked(ret1) or self._RF.IsLocked(r1) or self._RF.IsLocked(r2)  or (code1<3) or (code2<3) or (code3<3):
            ...
            s1 =( (self._RF[r1 + '_e3']<<96) + (self._RF[r1 + '_e2']<<64) + 
                  (self._RF[r1 + '_e2']<<32) +  self._RF[r1 + '_e0'] )
            s2 =( (self._RF[r2 + '_e3']<<96) + (self._RF[r1 + '_e2']<<64) + 
                  (self._RF[r2 + '_e1']<<32) +  self._RF[r1 + '_e0'] )
            self._Log.write("Source Reg 1 : %s = %x  \nSource Reg 2 : %s = %x  \n"%(r1, s1, r2, s2))
            result = s1 & s2
            self._RF[ret1 + '_e3'], self._RF[ret1 + '_e2'], self._RF[ret1 + '_e1'], self._RF[ret1 + '_e0'] = bit128_to_32(s1 & s2)
            # Information to be reported
            Matched, Instr = self._InstrSet.MatchedOnce(Asm)
            self.IncreaseIC(Instr)
            self.IncreaseCycles(Instr, "Serial", self._InstrSet.GetCycles(Instr))
    ...
    def _Execqnot    (self, Asm="", PC=None):
        ...
        if self._RF.IsLocked(ret1) or self._RF.IsLocked(r1):
            ...
            s1 = self._RF[r1 + '_e0']
            self._Log.write("Source Reg 1 : %s = %x  \n"%(r1, s1))
            self._RF[ret1 + '_e0'] = int("0xffffffff", 16) - s1
            # Information to be reported
            Matched, Instr = self._InstrSet.MatchedOnce(Asm)
            self.IncreaseIC(Instr)
            self.IncreaseCycles(Instr, "Serial", self._InstrSet.GetCycles(Instr))
    ...
    def _Execqnot64    (self, Asm="", PC=None):
        ...
        if self._RF.IsLocked(ret1) or self._RF.IsLocked(r1):
            ...
            self._RF[ret1 + '_e1'], self._RF[ret1 + '_e0'] = bit64_to_32(int("0xffffffffffffffff", 16) - s1)
            # Information to be reported
            Matched, Instr = self._InstrSet.MatchedOnce(Asm)
            self.IncreaseIC(Instr)
            self.IncreaseCycles(Instr, "Serial", self._InstrSet.GetCycles(Instr))
    ...
    def _Execqnot128    (self, Asm="", PC=None):
        ...
        if self._RF.IsLocked(ret1) or self._RF.IsLocked(r1):
            ...
            self._RF[ret1 + '_e3'], self._RF[ret1 + '_e2'], self._RF[ret1 + '_e1'], self._RF[ret1 + '_e0'] = bit128_to_32(int("0xffffffffffffffffffffffffffffffff", 16) - s1)
            # Information to be reported
            Matched, Instr = self._InstrSet.MatchedOnce(Asm) 
            self.IncreaseIC(Instr)
            self.IncreaseCycles(Instr, "Serial", self._InstrSet.GetCycles(Instr))
    ...
    def _Execqadd128(self, Asm="", PC=None):
        ...
        if self._RF.IsLocked(ret1) or self._RF.IsLocked(r1) or self._RF.IsLocked(r2)  or (code1<3) or (code2<3) or (code3<3):
            ...
            tempt = s1 + s2
            if tempt>=(1<<128):
                self._RF[ret], self._RF[split3 + str(code3-1)],  self._RF[split3 + str(code3-2)], self._RF[split3 + str(code3-3)] = bit128_to_32(tempt - (1<<128))
                self._RF['CY'] = 1
            else:
                self._RF[ret], self._RF[split3 + str(code3-1)],  self._RF[split3 + str(code3-2)], self._RF[split3 + str(code3-3)] = bit128_to_32(tempt)
                self._RF['CY'] = 0
            # Information to be reported
            Matched, Instr = self._InstrSet.MatchedOnce(Asm)
            self.IncreaseIC(Instr)
    ...
    def _Execqirol32(self, Asm="", PC=None):
        ...
        s1 = self._RF[r1]
        self._Log.write("Source Reg 1 : %s = %x  \nImm: %x  \n" % (r1, s1, imm))
        if (((bin(s1<<imm)[2:])[::-1])[32:])[::-1]=='':
            self._RF[ret] = int(((((bin(s1<<imm)[2:])[::-1])[0:32])[::-1]), 2)
        else:
            self._RF[ret] = int(((((bin(s1<<imm)[2:])[::-1])[0:32])[::-1]), 2) + int(((((bin(s1<<imm)[2:])[::-1])[32:])[::-1]), 2)
        # Information to be reported
        Matched, Instr = self._InstrSet.MatchedOnce(Asm)
        self.IncreaseIC(Instr)
        self.IncreaseCycles(Instr, "Serial", self._InstrSet.GetCycles(Instr))
    ...
    def _Execqirol8(self, Asm="", PC=None):
        ...
        if ((bin(s1)[2:])[::-1])[24:32]=='':
            r1_H_16_H_8 = 0
        elif ((bin((int((((bin(s1)[2:])[::-1])[24:32])[::-1], 2)<<imm))[2:])[::-1])[8:]=='':
            r1_H_16_H_8 = int((((bin((int((((bin(s1)[2:])[::-1])[24:32])[::-1], 2)<<imm))[2:])[::-1])[0:8])[::-1], 2)
        else:
            r1_H_16_H_8 = int((((bin((int((((bin(s1)[2:])[::-1])[24:32])[::-1], 2)<<imm))[2:])[::-1])[0:8])[::-1], 2) + int((((bin((int((((bin(s1)[2:])[::-1])[24:32])[::-1], 2)<<imm))[2:])[::-1])[8:])[::-1], 2)
        if ((bin(s1)[2:])[::-1])[16:24]=='':
            r1_H_16_L_8 = 0
        elif ((bin((int((((bin(s1)[2:])[::-1])[16:24])[::-1], 2)<<imm))[2:])[::-1])[8:]=='':
            r1_H_16_H_8 = int((((bin((int((((bin(s1)[2:])[::-1])[16:24])[::-1], 2)<<imm))[2:])[::-1])[0:8])[::-1], 2)
        else:
            r1_H_16_L_8 = int((((bin((int((((bin(s1)[2:])[::-1])[16:24])[::-1], 2)<<imm))[2:])[::-1])[0:8])[::-1], 2) + int((((bin((int((((bin(s1)[2:])[::-1])[16:24])[::-1], 2)<<imm))[2:])[::-1])[8:])[::-1], 2)
        if ((bin(s1)[2:])[::-1])[8:16]=='':
            r1_L_16_H_8 = 0
        elif ((bin((int((((bin(s1)[2:])[::-1])[8:16])[::-1], 2)<<imm))[2:])[::-1])[8:]=='':
            r1_H_16_H_8 = int((((bin((int((((bin(s1)[2:])[::-1])[8:16])[::-1], 2)<<imm))[2:])[::-1])[0:8])[::-1], 2)
        else:
            r1_L_16_H_8 = int((((bin((int((((bin(s1)[2:])[::-1])[8:16])[::-1], 2)<<imm))[2:])[::-1])[0:8])[::-1], 2) + int((((bin((int((((bin(s1)[2:])[::-1])[8:16])[::-1], 2)<<imm))[2:])[::-1])[8:])[::-1], 2)
        if ((bin(s1)[2:])[::-1])[0:8]=='':
            r1_L_16_L_8 = 0
        elif ((bin((int((((bin(s1)[2:])[::-1])[0:8])[::-1], 2)<<imm))[2:])[::-1])[8:]=='':
            r1_L_16_L_8 = int((((bin((int((((bin(s1)[2:])[::-1])[0:8])[::-1], 2)<<imm))[2:])[::-1])[0:8])[::-1], 2)
        else:
            r1_L_16_L_8 = int((((bin((int((((bin(s1)[2:])[::-1])[0:8])[::-1], 2)<<imm))[2:])[::-1])[0:8])[::-1], 2) + int((((bin((int((((bin(s1)[2:])[::-1])[0:8])[::-1], 2)<<imm))[2:])[::-1])[8:])[::-1], 2)
        self._RF[ret] = (r1_H_16_H_8<<24) + (r1_H_16_L_8<<16) + (r1_L_16_H_8<<8) + (r1_L_16_L_8)
        # Information to be reported
        Matched, Instr = self._InstrSet.MatchedOnce(Asm)
        self.IncreaseIC(Instr)
    ...
    def _Execqrol32(self, Asm="", PC=None):
        ...
        if (shift != 0):
            ...
            self._RF[ret] = int(((((bin(s1<<shift)[2:])[::-1])[0:32])[::-1]), 2) + int(((bin(s1)[::-1])[32:])[::-1], 2)
        # Information to be reported
        Matched, Instr = self._InstrSet.MatchedOnce(Asm)
        self.IncreaseIC(Instr)
        self.IncreaseCycles(Instr, "Serial", self._InstrSet.GetCycles(Instr))
    ...
    def _Execqrol8(self, Asm="", PC=None):
        ...
        s2 = self._RF[r2]
        self._Log.write("Source Reg 1 : %s = %x  \nReg 2 : %s = %x  \n" % (r1, s1, r2, s2))
        shift = int((((bin(self._RF[r2])[2:])[::-1])[0:3])[::-1], 2)
        if (shift == 0):
            self._RF[ret] = s1
        else :
            if ((bin(s1)[2:])[::-1])[24:32] == '':
                r1_H_16_H_8 = 0
            elif ((bin((int((((bin(s1)[2:])[::-1])[24:32])[::-1], 2)<<shift))[2:])[::-1])[8:] == '':
                r1_H_16_H_8 = int((((bin((int((((bin(s1)[2:])[::-1])[24:32])[::-1], 2)<<shift))[2:])[::-1])[0:8])[::-1], 2)
            else:
                r1_H_16_H_8 = int((((bin((int((((bin(s1)[2:])[::-1])[24:32])[::-1], 2)<<shift))[2:])[::-1])[0:8])[::-1], 2) + int((((bin((int((((bin(s1)[2:])[::-1])[24:32])[::-1], 2)<<shift))[2:])[::-1])[8:])[::-1], 2)
            if ((bin(s1)[2:])[::-1])[16:24] == '':
                r1_H_16_L_8 = 0
            elif ((bin((int((((bin(s1)[2:])[::-1])[16:24])[::-1], 2)<<shift))[2:])[::-1])[8:] == '':
                r1_H_16_L_8 = int((((bin((int((((bin(s1)[2:])[::-1])[16:24])[::-1], 2)<<shift))[2:])[::-1])[0:8])[::-1], 2)
            else:
                r1_H_16_L_8 = int((((bin((int((((bin(s1)[2:])[::-1])[16:24])[::-1], 2)<<shift))[2:])[::-1])[0:8])[::-1], 2) + int((((bin((int((((bin(s1)[2:])[::-1])[16:24])[::-1], 2)<<shift))[2:])[::-1])[8:])[::-1], 2)
            if ((bin(s1)[2:])[::-1])[8:16] == '':
                r1_L_16_H_8 = 0
            elif ((bin((int((((bin(s1)[2:])[::-1])[8:16])[::-1], 2)<<shift))[2:])[::-1])[8:] == '':
                r1_L_16_H_8 = int((((bin((int((((bin(s1)[2:])[::-1])[8:16])[::-1], 2)<<shift))[2:])[::-1])[0:8])[::-1], 2)
            else:
                r1_L_16_H_8 = int((((bin((int((((bin(s1)[2:])[::-1])[8:16])[::-1], 2)<<shift))[2:])[::-1])[0:8])[::-1], 2) + int((((bin((int((((bin(s1)[2:])[::-1])[8:16])[::-1], 2)<<shift))[2:])[::-1])[8:])[::-1], 2)
            if ((bin(s1)[2:])[::-1])[0:8] == '':
                r1_L_16_L_8 = 0
            elif ((bin((int((((bin(s1)[2:])[::-1])[0:8])[::-1], 2)<<shift))[2:])[::-1])[8:] == '':
                r1_L_16_L_8 = int((((bin((int((((bin(s1)[2:])[::-1])[0:8])[::-1], 2)<<shift))[2:])[::-1])[0:8])[::-1], 2)
            else:
                r1_L_16_L_8 = int((((bin((int((((bin(s1)[2:])[::-1])[0:8])[::-1], 2)<<shift))[2:])[::-1])[0:8])[::-1], 2) + int((((bin((int((((bin(s1)[2:])[::-1])[0:8])[::-1], 2)<<shift))[2:])[::-1])[8:])[::-1], 2)
            self._RF[ret] = (r1_H_16_H_8<<24) + (r1_H_16_L_8<<16) + (r1_L_16_H_8<<8) + (r1_L_16_L_8)
        # Information to be reported
        Matched, Instr = self._InstrSet.MatchedOnce(Asm)
        self.IncreaseIC(Instr)
    ...
    def _Execqiror32(self, Asm="", PC=None):
        ...
        if (imm == 0):
            ...
            self._RF[ret] = int(((((bin(s1>>imm)[2:])[::-1])[0:32])[::-1]), 2) + int(((((bin(s1)[2:])[::-1])[0:imm])[::-1]), 2)<<(32-imm)
        # Information to be reported
        Matched, Instr = self._InstrSet.MatchedOnce(Asm)
        self.IncreaseIC(Instr)
        self.IncreaseCycles(Instr, "Serial", self._InstrSet.GetCycles(Instr))
    ...
    def _Execqiror8(self, Asm="", PC=None):
        ...
        if (imm == 0):
            ...
            if ((bin(s1)[2:])[::-1])[24:32] == '':
                ...
                r1_H_16_H_8 = int((((bin((int((((bin(s1)[2:])[::-1])[24:32])[::-1], 2)>>imm))[2:])[::-1])[0:8])[::-1], 2) + int((((bin(s1)[2:])[::-1])[24:24+imm])[::-1], 2)<<(8-imm)
            if ((bin(s1)[2:])[::-1])[16:24] == '':
                r1_H_16_L_8 = 0
            elif ((bin((int((((bin(s1)[2:])[::-1])[16:24])[::-1], 2)>>imm))[2:])[::-1])[8:] == '':
                r1_H_16_L_8 = int((((bin((int((((bin(s1)[2:])[::-1])[16:24])[::-1], 2)>>imm))[2:])[::-1])[0:8])[::-1], 2)
            else:
                r1_H_16_L_8 = int((((bin((int((((bin(s1)[2:])[::-1])[16:24])[::-1], 2)>>imm))[2:])[::-1])[0:8])[::-1], 2) + int((((bin(s1)[2:])[::-1])[16:16+imm])[::-1], 2)<<(8-imm)
            if ((bin(s1)[2:])[::-1])[8:16] == '':
                r1_L_16_H_8 = 0
            elif ((bin((int((((bin(s1)[2:])[::-1])[8:16])[::-1], 2)>>imm))[2:])[::-1])[8:] == '':
                r1_L_16_H_8 = int((((bin((int((((bin(s1)[2:])[::-1])[8:16])[::-1], 2)>>imm))[2:])[::-1])[0:8])[::-1], 2)
            else:
                r1_L_16_H_8 = int((((bin((int((((bin(s1)[2:])[::-1])[8:16])[::-1], 2)>>imm))[2:])[::-1])[0:8])[::-1], 2) + int((((bin(s1)[2:])[::-1])[8:8+imm])[::-1], 2)<<(8-imm)
            if ((bin(s1)[2:])[::-1])[0:8] == '':
                r1_L_16_L_8 = 0
            elif ((bin((int((((bin(s1)[2:])[::-1])[0:8])[::-1], 2)>>imm))[2:])[::-1])[8:] == '':
                r1_L_16_L_8 = int((((bin((int((((bin(s1)[2:])[::-1])[0:8])[::-1], 2)>>imm))[2:])[::-1])[0:8])[::-1], 2)
            else:
                r1_L_16_L_8 = int((((bin((int((((bin(s1)[2:])[::-1])[0:8])[::-1], 2)>>imm))[2:])[::-1])[0:8])[::-1], 2) + int((((bin(s1)[2:])[::-1])[0:imm])[::-1], 2)<<(8-imm)
            self._RF[ret] = (r1_H_16_H_8<<24) + (r1_H_16_L_8<<16) + (r1_L_16_H_8<<8) + (r1_L_16_L_8)
        # Information to be reported
        Matched, Instr = self._InstrSet.MatchedOnce(Asm)
        self.IncreaseIC(Instr)
    ...
    def _Execqror32(self, Asm="", PC=None):
        ...
        if (shift != 0):
            ...
            self._RF[ret] = int(((((bin(s1>>shift)[2:])[::-1])[0:32])[::-1]), 2) + int(((bin(s1)[::-1])[0:shift])[::-1], 2)<<(32-shift)
        # Information to be reported
        Matched, Instr = self._InstrSet.MatchedOnce(Asm)
        self.IncreaseIC(Instr)
        self.IncreaseCycles(Instr, "Serial", self._InstrSet.GetCycles(Instr))
    ...
    def _Execqror8(self, Asm="", PC=None):
        ...
        if (shift ==0):
            ...
            if ((bin(self._RF[r1])[2:])[::-1])[24:32] == '':
                r1_H_16_H_8 = 0
            elif ((bin((int((((bin(self._RF[r1])[2:])[::-1])[24:32])[::-1], 2)>>shift))[2:])[::-1])[8:] == '':
                r1_H_16_H_8 = int((((bin((int((((bin(self._RF[r1])[2:])[::-1])[24:32])[::-1], 2)>>shift))[2:])[::-1])[0:8])[::-1], 2)
            else:
                r1_H_16_H_8 = int((((bin((int((((bin(self._RF[r1])[2:])[::-1])[24:32])[::-1], 2)>>shift))[2:])[::-1])[0:8])[::-1], 2) + int((((bin(self._RF[r1])[2:])[::-1])[24:24+shift])[::-1], 2)<<(8-shift)
            if ((bin(self._RF[r1])[2:])[::-1])[16:24] == '':
                r1_H_16_L_8 = 0
            elif ((bin((int((((bin(self._RF[r1])[2:])[::-1])[16:24])[::-1], 2)>>shift))[2:])[::-1])[8:] == '':
                r1_H_16_L_8 = int((((bin((int((((bin(self._RF[r1])[2:])[::-1])[16:24])[::-1], 2)>>shift))[2:])[::-1])[0:8])[::-1], 2)
            else:
                r1_H_16_L_8 = int((((bin((int((((bin(self._RF[r1])[2:])[::-1])[16:24])[::-1], 2)>>shift))[2:])[::-1])[0:8])[::-1], 2) + int((((bin(self._RF[r1])[2:])[::-1])[16:16+shift])[::-1], 2)<<(8-shift)
            if ((bin(self._RF[r1])[2:])[::-1])[8:16] == '':
                r1_L_16_H_8 = 0
            elif ((bin((int((((bin(self._RF[r1])[2:])[::-1])[8:16])[::-1], 2)>>shift))[2:])[::-1])[8:] == '':
                r1_L_16_H_8 = int((((bin((int((((bin(self._RF[r1])[2:])[::-1])[8:16])[::-1], 2)>>shift))[2:])[::-1])[0:8])[::-1], 2)
            else:
                r1_L_16_H_8 = int((((bin((int((((bin(self._RF[r1])[2:])[::-1])[8:16])[::-1], 2)>>shift))[2:])[::-1])[0:8])[::-1], 2) + int((((bin(self._RF[r1])[2:])[::-1])[8:8+shift])[::-1], 2)<<(8-shift)
            if ((bin(self._RF[r1])[2:])[::-1])[0:8] == '':
                r1_L_16_L_8 = 0
            elif ((bin((int((((bin(self._RF[r1])[2:])[::-1])[0:8])[::-1], 2)>>shift))[2:])[::-1])[8:] == '':
                r1_L_16_L_8 = int((((bin((int((((bin(self._RF[r1])[2:])[::-1])[0:8])[::-1], 2)>>shift))[2:])[::-1])[0:8])[::-1], 2)
            else:
                r1_L_16_L_8 = int((((bin((int((((bin(self._RF[r1])[2:])[::-1])[0:8])[::-1], 2)>>shift))[2:])[::-1])[0:8])[::-1], 2) + int((((bin(self._RF[r1])[2:])[::-1])[0:shift])[::-1], 2)<<(8-shift)
        self._RF[ret] = (r1_H_16_H_8<<24) + (r1_H_16_L_8<<16) + (r1_L_16_H_8<<8) + (r1_L_16_L_8)
        # Information to be reported
        Matched, Instr = self._InstrSet.MatchedOnce(Asm)
        self.IncreaseIC(Instr)
    ...
    def _Execq4lut8m8(self, Asm="", PC=None):
        ...
        rd2 = self._RF[split1.group(3) + str(code1 - 1)] = (s21_s<<24) + (s22_s<<16) + (s23_s<<8) + (s24_s)
        rd3 = self._RF[split1.group(3) + str(code1 - 2)] = (s31_s<<24) + (s32_s<<16) + (s33_s<<8) + (s34_s)
        rd4 = self._RF[split1.group(3) + str(code1 - 3)] = (s41_s<<24) + (s42_s<<16) + (s43_s<<8) + (s44_s)
    ...
    def _Execqgf8_matv    (self, Asm="", PC=None):
        ...
        code1 = int(split1.group(2), 10) 
        code3 = int(split3.group(2), 10) 
        if self._RF.IsLocked(ret1) or self._RF.IsLocked(r1) or self._RF.IsLocked(r2) or (code1<7) or (code3<3):
            return False, PC
        else:
            ...
            d11 = int((((bin(c11 * s11 + c12 * s21 + c13 * s31 + c14 * s41)[2:])[::-1])[0:8])[::-1], 2)
            d12 = int((((bin(c11 * s12 + c12 * s22 + c13 * s32 + c14 * s42)[2:])[::-1])[0:8])[::-1], 2)
            d13 = int((((bin(c11 * s13 + c12 * s23 + c13 * s33 + c14 * s43)[2:])[::-1])[0:8])[::-1], 2)
            d14 = int((((bin(c11 * s14 + c12 * s24 + c13 * s34 + c14 * s44)[2:])[::-1])[0:8])[::-1], 2)
            d21 = int((((bin(c21 * s11 + c22 * s21 + c23 * s31 + c24 * s41)[2:])[::-1])[0:8])[::-1], 2)           
            d22 = int((((bin(c21 * s12 + c22 * s22 + c23 * s32 + c24 * s42)[2:])[::-1])[0:8])[::-1], 2)           
            d23 = int((((bin(c21 * s13 + c22 * s23 + c23 * s33 + c24 * s43)[2:])[::-1])[0:8])[::-1], 2)           
            d24 = int((((bin(c21 * s14 + c22 * s24 + c23 * s34 + c24 * s44)[2:])[::-1])[0:8])[::-1], 2)
            d31 = int((((bin(c31 * s11 + c32 * s21 + c33 * s31 + c34 * s41)[2:])[::-1])[0:8])[::-1], 2)           
            d32 = int((((bin(c31 * s12 + c32 * s22 + c33 * s32 + c34 * s42)[2:])[::-1])[0:8])[::-1], 2)           
            d33 = int((((bin(c31 * s13 + c32 * s23 + c33 * s33 + c34 * s43)[2:])[::-1])[0:8])[::-1], 2)           
            d34 = int((((bin(c31 * s14 + c32 * s24 + c33 * s34 + c34 * s44)[2:])[::-1])[0:8])[::-1], 2) 
            d41 = int((((bin(c41 * s11 + c42 * s21 + c43 * s31 + c44 * s41)[2:])[::-1])[0:8])[::-1], 2)           
            d42 = int((((bin(c41 * s12 + c42 * s22 + c43 * s32 + c44 * s42)[2:])[::-1])[0:8])[::-1], 2)           
            d43 = int((((bin(c41 * s13 + c42 * s23 + c43 * s33 + c44 * s43)[2:])[::-1])[0:8])[::-1], 2)           
            d44 = int((((bin(c41 * s14 + c42 * s24 + c43 * s34 + c44 * s44)[2:])[::-1])[0:8])[::-1], 2)           			
            s1 = (d11<<24)	+ (d21<<16) + (d31<<8) + d41		
            s2 = (d12<<24)	+ (d22<<16) + (d32<<8) + d42		
            s3 = (d13<<24)	+ (d23<<16) + (d33<<8) + d43		
            s4 = (d14<<24)	+ (d24<<16) + (d34<<8) + d44
...
class CryptoRegFiles:
    def __init__(self):
        ...
        V12 ={"V12_e0" : {"Value" : 0, "Locked" : False},
...
class CryptoInstrSet:
    def __init__(self):
        ...
        self._InstrParams = {
                ...
                "mv": {"Cycles": 1,
                   "Exec": None,
                   "Pattern": re.compile("\s+mv\s+(\w+)\,\s+(\w+)\,\s+(\w+)"),
                   "Params": 0},
                "bjlab": {"Cycles": 1,
                   "Exec": None,
